...
СНЯТЬ_ПО_ШАГУ = {
    ...
    "o1_сюжеты.py": "10_сюжеты.jsonl",
    "o1_баллы.py": "10_исключения.json",   # контракт П3 проверяется здесь
...
def правка_цитат(лог, папка):
    ...
    if шаг == "b4т_проверка_тем.py":
        ...
        if "недословна" in лог or "переставлены" in лог or "цитата пуста" in лог:
